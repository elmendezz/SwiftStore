...
struct AnimatedRender3D: View {
    @State private var phase: Double = 0
    @AppStorage("enableCreditsGlow") private var enableCreditsGlow: Bool = false
    ...
    var body: some View {
        ZStack {
            Circle()
                ...
                .if(enableCreditsGlow) { view in
                    view.shadow(color: .cyan.opacity(0.5), radius: 10)
                }
            ...
            RoundedRectangle(cornerRadius: 25)
                ...
                .if(enableCreditsGlow) { view in
                    view.shadow(color: .purple.opacity(0.5), radius: 10)
                }
            ...
            Capsule()
                ...
                .if(enableCreditsGlow) { view in
                    view.shadow(color: .pink.opacity(0.5), radius: 10)
                }
        }
        .if(enableCreditsGlow) { view in
            view.blur(radius: 2)
